...
In order to support loading of multiple wallets in SixtyNine-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is SixtyNine.cpp.
...
Changes to SixtyNine.cpp
----------------------
SixtyNine.cpp is the entry point into SixtyNine-qt, and as such, will require some minor modifications to provide hooks for
