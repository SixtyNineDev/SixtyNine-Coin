...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SixtyNine server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "SixtyNine server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SixtyNine features */
        {"SixtyNine", "masternode", &masternode, true, true, false},
        {"SixtyNine", "listmasternodes", &listmasternodes, true, true, false},
        {"SixtyNine", "getmasternodecount", &getmasternodecount, true, true, false},
        {"SixtyNine", "masternodeconnect", &masternodeconnect, true, true, false},
        {"SixtyNine", "masternodecurrent", &masternodecurrent, true, true, false},
        {"SixtyNine", "masternodedebug", &masternodedebug, true, true, false},
        {"SixtyNine", "startmasternode", &startmasternode, true, true, false},
        {"SixtyNine", "createmasternodekey", &createmasternodekey, true, true, false},
        {"SixtyNine", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"SixtyNine", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"SixtyNine", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"SixtyNine", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"SixtyNine", "getmasternodescores", &getmasternodescores, true, true, false},
        {"SixtyNine", "mnbudget", &mnbudget, true, true, false},
        {"SixtyNine", "preparebudget", &preparebudget, true, true, false},
        {"SixtyNine", "submitbudget", &submitbudget, true, true, false},
        {"SixtyNine", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"SixtyNine", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"SixtyNine", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"SixtyNine", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"SixtyNine", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"SixtyNine", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"SixtyNine", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"SixtyNine", "checkbudgets", &checkbudgets, true, true, false},
        {"SixtyNine", "mnsync", &mnsync, true, true, false},
        {"SixtyNine", "spork", &spork, true, true, false},
        {"SixtyNine", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"SixtyNine", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use SixtyNined, or the -server option to SixtyNine-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               "It is recommended you use the following random password:\n"
                                               "rpcuser=SixtyNinerpc\n"
                                               "rpcpassword=%s\n"
                                               "(you do not need to remember this password)\n"
                                               "The username and password MUST NOT be the same.\n"
                                               "If the file does not exist, create it with owner-readable-only file permissions.\n"
                                               "It is also recommended to set alertnotify so you are notified of problems;\n"
                                               "for example: alertnotify=echo %%s | mail -s \"SixtyNine Alert\" admin@foo.com\n"),
...
{
    return "> SixtyNine-cli " + methodname + " " + args + "\n";
}
