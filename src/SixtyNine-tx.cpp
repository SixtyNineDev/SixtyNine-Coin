...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SixtyNine Core SixtyNine-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  SixtyNine-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded SixtyNine transaction") + "\n" +
                               "  SixtyNine-tx [options] -create [commands]   " + _("Create hex-encoded SixtyNine transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded SixtyNine  transaction
