...
{
    BOOST_CHECK(TestSplitHost("www.SixtyNinecoin.com", "www.SixtyNinecoin.com", -1));
    BOOST_CHECK(TestSplitHost("[www.SixtyNinecoin.com]", "www.SixtyNinecoin.com", -1));
    BOOST_CHECK(TestSplitHost("www.SixtyNinecoin.com:80", "www.SixtyNinecoin.com", 80));
    BOOST_CHECK(TestSplitHost("[www.SixtyNinecoin.com]:80", "www.SixtyNinecoin.com", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:36969", "127.0.0.1", 36969));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:36969", "127.0.0.1", 36969));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:36969", "::ffff:127.0.0.1", 36969));
    BOOST_CHECK(TestSplitHost("[::]:36969", "::", 36969));
    BOOST_CHECK(TestSplitHost("::36969", "::36969", -1));
    BOOST_CHECK(TestSplitHost(":36969", "", 36969));
    BOOST_CHECK(TestSplitHost("[]:36969", "", 36969));
...
{
    BOOST_CHECK(TestParse("127.0.0.1", "127.0.0.1:36969"));
    BOOST_CHECK(TestParse("127.0.0.1:36969", "127.0.0.1:36969"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:36969"));
    BOOST_CHECK(TestParse("::", "[::]:36969"));
    BOOST_CHECK(TestParse("[::]:36969", "[::]:36969"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:36969"));
