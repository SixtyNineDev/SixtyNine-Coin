...
/** Utility functions used by the SixtyNine Qt UI.
 */
namespace GUIUtil
{
...
// Render SixtyNine addresses in monospace font
...
// Parse "SixtyNine:" URI into recipient object, return true on successful parsing
