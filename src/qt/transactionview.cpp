                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received SXT from zSXT"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zSXT"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zSXT));
