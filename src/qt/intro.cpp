...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SixtyNine Core"),
     ...
     * override -datadir in the SixtyNine.conf file in the default data directory
     * (to be consistent with SixtyNined behavior)
     */
    if (dataDir != getDefaultDataDirectory())
