                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SixtyNine Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SixtyNine address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and SixtyNine: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSXT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SixtyNine Core"), this);
    aboutAction->setStatusTip(tr("Show information about SixtyNine Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SixtyNine"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SixtyNine addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SixtyNine addresses"));
    ...
    openAction->setStatusTip(tr("Open a SixtyNine: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SixtyNine Core help message to get a list with possible SixtyNine command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SixtyNine Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SixtyNine network", "", count));
}
...
{
    QString strTitle = tr("SixtyNine Core"); // default title
