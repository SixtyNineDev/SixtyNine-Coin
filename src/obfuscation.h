...
{
public:
    /// Is the inputs associated with this public key? (and there is 6969 SXT - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of SixtyNine.
