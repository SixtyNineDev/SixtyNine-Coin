Contributing to SixtyNine Core
============================

The SixtyNine Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SixtyNine Core project, and is not to be
confused with overall SixtyNine Network Protocol consensus changes.

Whether a pull request is merged into SixtyNine Core rests with the project merge
...
Patches that change SixtyNine consensus rules are considerably more involved than
...
Where a patch set proposes to change the SixtyNine consensus, it must have been
...
The project leader is the release manager for each SixtyNine Core release.
